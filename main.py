...
def initialize_db():
    ...
    c = conn.cursor()
    c.execute('''CREATE TABLE IF NOT EXISTS bad_words (word TEXT UNIQUE)''')
    conn.commit()
    conn.close()
